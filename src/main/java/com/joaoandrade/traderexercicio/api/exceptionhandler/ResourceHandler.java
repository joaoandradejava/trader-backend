...
public class ResourceHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleNoHandlerFoundException(NoHandlerFoundException ex, HttpHeaders headers,
		...
		String message = String.format("Não existe nenhum endpoint mapeado para %s%s", ex.getHttpMethod(),
				ex.getRequestURL());
		ProblemDetail problemDetail = new ProblemDetail(error.getType(), error.getTitle(), status.value(), message,
				DEFAULT_MESSAGE);
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
		...
		String message = "Erro ao tentar fazer a desserialização do JSON. Verifique se a sintaxe do JSON foi inserida corretamente no corpo da requisição.";
		ProblemDetail problemDetail = new ProblemDetail(error.getType(), error.getTitle(), status.value(), message,
				DEFAULT_MESSAGE);
	...
	protected ResponseEntity<Object> handleHttpRequestMethodNotSupported(HttpRequestMethodNotSupportedException ex,
		...
		String message = String.format("A Requisição feita para o Método '%s' não é suportada!", ex.getMethod());
		ProblemDetail problemDetail = new ProblemDetail(error.getType(), error.getTitle(), status.value(), message,
				DEFAULT_MESSAGE);
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		String message = "Ocorreu um erro de validação dos dados. Verifique se os dados foram inseridos corretamente no corpo daa requisição";
		ProblemDetail problemDetail = new ProblemDetail(error.getType(), error.getTitle(), status.value(), message,
				message);
	...
	private ResponseEntity<Object> handleUnrecognizedProperty(UnrecognizedPropertyException ex, HttpHeaders headers,
		...
		String message = String.format("A Propriedade '%s' inserida no corpo da requisição é inexistente!",
				ex.getPropertyName());
		ProblemDetail problemDetail = new ProblemDetail(error.getType(), error.getTitle(), status.value(), message,
				DEFAULT_MESSAGE);
